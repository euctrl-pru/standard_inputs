...
The EUROCONTROL Ground-based Navigation Infrastructure Map Tool[@gbnimap]
...
information published in the European AIS Database (EAD)[@ectrlead] and the planning 
...
@tbl-cns-ecac-surv shows the number of Surveillance units in ECAC as per 2022. 
