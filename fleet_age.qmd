...
![Average aircraft age per flight in EU27 + EFTA. *Source: EUROCONTROL STATFOR Interactive Dashboard* [@ectrl:statfor:sid]](figures/aircraft_age_per_flight.svg){#fig-average-aircraft-age}
...
### Commercial aircraft fleet by age of aircraft (EU27+EFTA+UK) 

@fig-com-aircraft-fleet shows commercial aircraft fleet by age of aircraft.

![Average aircraft age per flight in EU27 + EFTA UK. *source: EUROSTAT* [@eurostataircraftfleet]](figures/aircraft-fleet-by-age.svg){#fig-com-aircraft-fleet}
