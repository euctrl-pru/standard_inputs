...
### Average aircraft age per flight (EU27+EFTA^[European Free Trade Association whose Member States comprise Iceland, Liechtenstein, Norway and Switzerland]) 

@fig-average-aircraft-age shows the average aircraft age in years by EUROCONTROL market segment[@ectl:market:seg:2022] for the aircraft operating in 2022.
 
![Average aircraft age per flight in EU27 + EFTA[@ectrl:statfor:sid]](figures/aircraft_age_per_flight.svg){#fig-average-aircraft-age}
...
![Average aircraft age per flight  (EU27+EFTA+UK)[@eurostataircraftfleet]](figures/aircraft-fleet-by-age.svg){#fig-com-aircraft-fleet}
