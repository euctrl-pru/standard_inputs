...
![**Breakdown of the network average delay per flight on departure: 2021 vs 2020**](figures/delay_causes.png){#all-causes-delay}
...
![**Average daily traffic and ATFM delay per flight 2012-2022**](figures/atfm_delay.png){#atfm-delay}
