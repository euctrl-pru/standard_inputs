...
-   A selection of values has been updated according to the latest data available and published on the web:
    ...
    -   @sec-average-number-of-passengers [Average number of passengers](#sec-average-number-of-passengers)
-   Two new values have been introduced:
    -   @sec-shadow-cost-of-carbon [Shadow cost of carbon](#sec-shadow-cost-of-carbon)
    -   @sec-proportion-of-saf [Proportion of Sustainable Aviation Fuel](#sec-proportion-of-saf)
