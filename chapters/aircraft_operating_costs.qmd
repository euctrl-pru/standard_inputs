...
aircraft parking, air bridges and maintenance. The costs were originally estimated
in 2022 prices and were adjusted to 2025 based on inflation.

```{r}
#| label: tbl-aircraft-operating-cost
#| tbl-cap: Aircraft Operating Costs in USD 2025 prices
...
# Label row
  ...
  #Format numbers
  fmt_number(
    columns = c(per_aircraft,per_seats,per_ton_km),
    decimals = 2
  )%>% 
  fmt_number(
...
@fig-airline-costs-structure shows the average airline cost structure for 2019 
(considering that jet kerosene price is $66.9 per barrel).
