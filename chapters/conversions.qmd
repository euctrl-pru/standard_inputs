...
The rates correspond to the average rate for the year 2025 and are used across 
this document for the purpose of currency conversion.

```{r }
#| label: tbl-eurostat-exchange-rates
#| tbl-cap: Average euro foreign exchange rate in 2025
library(readr)
library(dplyr)
library(gt)
...
The cost of fuel used in this document is based on the 2025 average jet fuel
...
#| tbl-cap: Average jet fuel price in 2025
library(dplyr)
library(gt)
