...
-   *ICAO Carbon Emissions Calculator:* [@emissionscalc] ICAO has developed a 
...
-   *EUROCONTROL Advanced Emission Model (AEM):* [@ectrl:em:model] Standalone 
...
-   *ICAO Engine Emissions Databank:* [@icao:databank] Manufacturer’s datasheets 
