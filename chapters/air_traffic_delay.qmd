...
are calculated based on the comparison of the scheduled and actual flight timings [@coda2021].
...
delays due to the restrictions that may be applied in the airspace [@nm2022].
