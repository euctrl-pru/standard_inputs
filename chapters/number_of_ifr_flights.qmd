...
read_xlsx(here::here("data", "flight_per_market_segment.xlsx")) %>%
  ...
  cols_label(
    ...
    share_of_total_2024 = "Share of Total 2024",
    y2019 = "2019",
    y2024 = "2024"
  ) %>%
  fmt_percent(
    columns = c(share_of_total_2019, share_of_total_2024),
    decimals = 0
  ) %>%
  fmt_number(
    columns = c(y2019, y2024),
    use_seps = TRUE,
    decimals = 0
  ) %>%
  cols_align(
