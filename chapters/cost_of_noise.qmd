...
read_xlsx(here::here("data", "cost_noise.xlsx"),
  ...
  tab_footnote(
    footnote = "The monetary values originate from Table 33 of the source document and are adjusted from 2016 to 2025 prices",
...
read_xlsx(here::here("data", "cost_noise.xlsx"),
  ...
  tab_footnote(
    footnote = "The monetary values originate from Table 36 of the source document and are adjusted from 2016 to 2025 prices",
    locations = cells_column_labels(
      columns = total:km
    )
  ) %>% 
...
read_xlsx(here::here("data", "cost_noise.xlsx"),
  ...
  tab_footnote(
    footnote = "The monetary values originate from Tables A1.3 and A1.4 of the source document and are adjusted from 2014 to 2025 prices",
    locations = cells_column_labels(
      columns = marginal_cost:sleep
    )
  ) %>% 
...
This input is recommended for use in environmental assessments, and specifically 
when assessing the noise impacts from aviation activity.
