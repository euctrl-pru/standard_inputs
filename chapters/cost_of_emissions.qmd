...
read_xlsx(here::here("data", "emissions_cost.xlsx"),
  ...
  tab_footnote(
    footnote = "The values originate from Table 23 of the Handbook on the external costs of carbon and are adjusted from 2019 to 2022 prices according to inflation",
    locations = cells_column_labels(
      columns = low:high
    )
  ) %>% 
...
read_xlsx(here::here("data", "emissions_cost.xlsx"),
  ...
  tab_footnote(
    footnote = "The values originate from Table 51 of the Handbook on the external costs of carbon and are adjusted from 2019 to 2022 prices according to inflation",
    locations = cells_column_labels(
      columns = total:pax
    )
  )  %>% 
...
read_xlsx(here::here("data", "emissions_cost.xlsx"),
  ...
  tab_footnote(
    footnote = "The values originate from Table 14 of the Handbook on the external costs of carbon and are adjusted from 2016 to 2022 prices according to inflation",
    locations = cells_column_labels(
      columns = no:pm
    )
  ) %>%
