...
costs of transport.[@ecdgmove:2019]
...
read_xlsx(here::here("data", "emissions_cost.xlsx"),
  ...
  tab_footnote(
    footnote = "The values originate from Table 23 of the Handbook on the external costs of transport and are adjusted to 2025 prices according to inflation",
    locations = cells_column_labels(
...
read_xlsx(here::here("data", "emissions_cost.xlsx"),
  ...
  tab_footnote(
    footnote = "The values originate from Table 82 of the Handbook on the external costs of transport and are adjusted from 2016 to 2025 prices according to inflation",
    locations = cells_column_labels(
      columns = low:high
    )
  ) %>% 
...
read_xlsx(here::here("data", "emissions_cost.xlsx"),
  ...
  tab_footnote(
    footnote = "The values originate from Table 51 of the Handbook on the external costs of carbon and are adjusted from 2016 to 2025 prices according to inflation",
    locations = cells_column_labels(
      columns = total:pax
    )
  ) %>% 
...
read_xlsx(here::here("data", "emissions_cost.xlsx"),
  ...
  tab_footnote(
    footnote = "The values originate from Table 49 of the Handbook on the external costs of carbon and are adjusted from 2016 to 2025 prices according to inflation",
    locations = cells_column_labels(
      columns = no:pm
    )
  )
...
* *EASA (2025), European Environmental Report* [@eaer:2025]

* *European Commission Climate Action* [@ecc:limateaction]

* *UK Department for Environment, Food and Rural Affairs (DEFRA) (2025), Air quality damage cost update 2025* [@defra:2025]

## When to use the input?

This input is recommended for use in assessments focusing on the wider cost/impact
