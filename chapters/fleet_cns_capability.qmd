...
#| tbl-cap: NAV flight capabilities as a % of total flights in 2025
...
#| tbl-cap: NAV flight capabilities as a % at the top 10 European airports in 2025
...
read_xlsx(here::here("data", "cns_capability.xlsx"),
  ...
  cols_label(
    ...
    rnav = "RNAV 1 - Any means (any Dx)",
    rnp = "RNP 1 (any Ox)",
    rnp_apch = "RNP APCH (S1 or S2)"
  ) %>% 
  fmt_percent(
...
#| tbl-cap: NAV aircraft capability at the top-10 European airports over a one-month period, July 2025
...
tab_footnote(
    footnote = "Please note that the list of airports is different from Table 28.2 representing the most busy airports in the month of July (i.e. the month of analysis)",
    locations = cells_column_labels(
      columns = airport
    )
  ) 
...
#| tbl-cap: NAV flight capability by main aircraft model, December 2025
...
based on flights arriving at or departing from ECAC Airports and the data is originated from
...
#| tbl-cap: COM flight capabilities as a % of total flights in 2025
...
#| tbl-cap: COM datalink flight capabilities as a % at the Common Project 1 airports in 2025
...
#| tbl-cap: COM voice flight capabilities as a % at the Common Project 1 airports in 2025
...
#| tbl-cap: COM datalink flight capabilities for main aircraft models, December 2025
...
#| tbl-cap: COM voice flight capabilities for main aircraft models, December 2025
...
the situation for 2025. The data used is originated from
[EUROCONTROL Aircraft communication, navigation & surveillance (CNS) dashboard](https://www.eurocontrol.int/dashboard/communication-navigation-and-surveillance-dashboard). 
Please refer to this source for more detailed information and further data.

```{r}
#| label: tbl-sur-flight
#| tbl-cap: SUR flight capabilities as a % of total flights in 2025
...
```{r}
#| label: tbl-ssr-top10
#| tbl-cap: SSR/Mode S declared capabilities in flight plans at the top 10 European airports in 2025
...
#| tbl-cap: ADS-B declared capabilities in flight plans at the top 10 European airports in 2025
...
#| tbl-cap: SSR/Mode S declared capabilities in flight plans for main aircraft models, December 2025
...
#| tbl-cap: ADS-B declared capabilities in flight plans for main aircraft models, December 2025
