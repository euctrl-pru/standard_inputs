...
* *European Aviation Environmental Report* [@eaer:2025]
  
  The 2025 edition shows that the aviation sector is continuously taking steps 
  to address its impacts on the environment and climate. The report offers a 
  comprehensive overview on the past and forecasted environmental performance of 
  the aviation sector at the European level. It has been compiled by the European 
  Union Aviation Safety Agency (EASA) with support from a Steering Group comprising
  the European Commission, European Environment Agency (EEA) and EUROCONTROL.
