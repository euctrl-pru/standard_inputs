...
![EUROCONTROL Seven-year forecast 2026-2032 (Spring 2026 release) @EUROCONTROLForecastUpdate2025](../figures/forecast_2026-2032.png){#fig-forecast-2025-2031-plot}

The above graph shows the traffic forecast from 2019 to 2032. In the base scenario, IFR flights are expected to be back to 
...
![En-route Service Units Seven-year Forecast 2026-2032 (Spring 2026 release) [@EUROCONTROLForecastUpdate2025]](../figures/forecast_service_units.png){#fig-forecast-service-units-plot}

The above graph shows the en-route service units forecast from 2019 to 2032.
