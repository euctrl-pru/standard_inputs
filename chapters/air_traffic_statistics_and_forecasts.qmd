...
The EUROCONTROL Statistics and Forecast (STATFOR) service produces flight and
...
The medium-term forecasts give a comprehensive picture of **anticipated air traffic development in Europe (i.e. ECAC) for the next seven years.** These forecasts combine
flight statistics with economic growth and models of other industry drivers, 
...
to help planners manage risks. These forecasts are published biannually, in spring
and autumn, covering flights, en-route and terminal service units.
  
![EUROCONTROL 7-year forecast 2024-2030 (Spring 2024 release) @EUROCONTROLForecastUpdate2024](../figures/forecast_2024-2030.png){#fig-forecast-2024-2030-plot}
...
![Estimated CO~2~ emissions between 2005 and 2050 [@aviation:outlook2022]](../figures/eao_2050_base_scenario.png){#fig-co2-emissions-plot}
...
![En-route Service Units 7-year Forecast 2024-2030 (Spring 2024 release) [@EUROCONTROLForecastUpdate2024]](../figures/forecast_service_units.png){#fig-forecast-service-units-plot}
