...
The table shows the forecast of SAF blending percentage over total jet fuel for years 2022 to 2030. The values are provided based on the 3 forecast scenarios proposed by the [EUROCONTROL Aviation Outlook 2050](https://www.eurocontrol.int/publication/eurocontrol-aviation-outlook-2050). Namely:
...
*   [Objective Skygreen 2022-2030]'(https://www.eurocontrol.int/publication/objective-skygreen-2022-2030) assumes that the SAF blending percentages apply to all the airports within the NM area.
...
For further research, we invite you to visit the work of our colleagues at the [EUROCONTROL Aviation Sustainability Unit](https://www.eurocontrol.int/aviation-sustainability).

## When to use the input?

This input can be used when dealing with environmentally related assessments. at EUROCONTROL we have used this SAF blending for the traffic forecast in the [EUROCONTROL Aviation Outlook 2050](https://www.eurocontrol.int/publication/eurocontrol-aviation-outlook-2050) and for the [Objective Skygreen 2022-2030](https://www.eurocontrol.int/publication/objective-skygreen-2022-2030) exploring the economics of aviation decarbonisation towards the 2030 Green Deal milestone.
