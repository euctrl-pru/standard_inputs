...
---
# RMarkdown `r icon::fontawesome("markdown")` 1

```{r, echo=FALSE,out.width="75%"}
knitr::include_graphics("quicktourexample.png")
```
...
---
# RMarkdown `r icon::fontawesome("markdown")` 2

```{r, echo=FALSE,out.width="60%"}
knitr::include_graphics("markdownchunk.png")
```
...
---
# RMarkdown `r icon::fontawesome("markdown")` 3
...
knitr::include_graphics("workflows.png")
```
