...
This value represents the monetised benefits of an average passenger flight in EU27.^[[EU27 in 2013](https://ec.europa.eu/eurostat/statistics-explained/index.php/Glossary:EU_enlargements)]
The values were adjusted to 2022 price levels based on inflation.
...
The values quoted above are the result of a study on the benefits in monetary value of an average passenger flight in the EU27. 

IATA, in its briefing note, assesses the economic benefits of an average scheduled passenger flight from the perspective of the consumer, producers and the economy as a whole. Its approach to the various benefits is outlined below.
