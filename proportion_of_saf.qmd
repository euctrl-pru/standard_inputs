...
* **Base scenario**, where a moderate traffic growth and uptake of SAF is assumed, in line with _ReFuelEU Aviation_ [@easa:Fit55ReFuelEU] obligations .
...
read_xlsx("data/saf_blend.xlsx") %>%
  ...
  fmt_number(
   ...
   tab_source_note(source_note = "Source: EUROCONTROL (2022), Objective Skygreen 2022-2030. The economics of aviation decarbonisation towards the 2030 Green Deal milestone")
```
