...
The data that was used to build this table can be accessed on [AIU portal](https://ansperformance.eu/data/).
You can find there data for more recent years.
...
![**Average transit time per country in 2019**](figures/transit_time.svg){#fig-transit-time fig-align=center}
*Source: EUROCONTROL*
