...
Please note that the comparison between 2021 and 2019 in @tbl-ifr-flights-month is due to the fact that 2019 is the last year where the traffic levels were not affected by the COVID-19 pandemic, allowing for a more realistic comparison of the flight levels.
...
"Traditional Scheduled" segment split into "Mainline" and "Regional".
...
flights in Europe. 70% of the flights were carried out by the 20
aircraft types listed in @tbl-flights-per-aircraft-type.

### Daily average of IFR flights, 2016 to 2021

The graph below shows the daily average number of IFR flights EU-wide between 2016 and 2021.

![Daily average numbers of IFR flights](figures/average_daily_flights.png){#fig-average-daily-ifr-flights-plot}

*Source: Performance Review Board (PRB) - ANS performance monitoring (EU-wide)* [@prb:dashboard:2022]
...
[IFR flight information per operator segment](#sec-ifr-flight-information-per-market-segment)
