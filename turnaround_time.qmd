...
can be accessed, together with a number of additional information, on the [MIRROR tool](https://www.eurocontrol.int/tool/mirror).

```{r}
#| label: tbl-turnaround-time
#| tbl-cap: Scheduled vs. actual turnaround time in ECAC

read_xlsx("data/turnaround_time.xlsx",
          sheet = "time") %>% 
  gt() %>% 
  cols_label(
    year = "Year",
...
The table below presents, for 2019, an overview of turnaround time ranges for the
